...
function preload(){
  ...
  balloonAnimation = loadAnimation("Balloon03.png", "Balloon01.png", "Balloon02.png")
...
function setup() {
  ...
  coin_eg = createSprite(180,585,0,0)
  coin_eg.addImage(coinImg)
  coin_eg.scale = 0.12;

  diamond_eg = createSprite(622,583,0,0)
  diamond_eg.addImage(diamondImg)
  diamond_eg.scale = 0.11;

  money_eg = createSprite(1108,578,0,0)
